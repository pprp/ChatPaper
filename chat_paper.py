    ...
    def summary_with_chat(self, paper_list):
        ...
        for paper_index, paper in enumerate(paper_list):
            ...
            file_name = os.path.join(
                export_path, date_str + '-' +
                self.validateTitle(paper.title[:80]) + '.' + self.file_format)
    ...
    def chat_summary(self, text, summary_prompt_token=1100):
        ...
        messages = [
            ...
            },
            {
                ...
                'assistant',
                'content':
                f'This is the title, author, link, abstract and introduction of an English document. Read and summarize the following questions: {clip_text} in the format of markdown.'
            },
            {
                'role':
                'user',
            ...
            for root, dirs, files in os.walk(args.pdf_path):
                ...
                for filename in files:
                    ...
                    if filename.endswith('.pdf'):
                        paper_list.append(
                            Paper(path=os.path.join(root, filename)))
        print('------------------paper_num: {}------------------'.format(
            len(paper_list)))
        [
            print(paper_index,
                  paper_name.path.split('\\')[-1])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filter_keys',
                        type=str,
