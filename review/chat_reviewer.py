...
class Reviewer:
    ...
    def review_by_chatgpt(self, paper_list):
        ...
        for paper_index, paper in enumerate(paper_list):
            ...
            intro_title = next((item for item in paper.section_names
                                if 'ntroduction' in item.lower()), None)
            ...
            conclusion_title = next(
                (item for item in paper.section_names if 'onclusion' in item),
                None)
            ...
            file_name = os.path.join(
                export_path, date_str + '-' + self.validateTitle(paper.title) +
                '.' + self.file_format)
        ...
        messages = [
            {
                ...
                'system',
                'content':
                f'You are a professional reviewer in the field of {self.research_fields}. '
    ...
    def chat_review(self, text):
        ...
        input_text_index = int(
            len(text) * (self.max_token_num - review_prompt_token) /
            text_token)
        ...
        messages = [
            {
                ...
                + review_format + ' Please answer in {}.'.format(self.language)
            },
            {
                'role': 'user',
                'content': input_text
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        'computer science, artificial intelligence and reinforcement learning',
        help='the research fields of paper')
    parser.add_argument('--language',
                        type=str,
                        default='en',
                        help='output lauguage, en or zh')
